...
VCC_v1.1.0(2025/02/12) VRChat 2025.1.2 (OPEN BETA)以降のログファイル形式に対応 ->OutputLogLoaderをv1.1.0に更新　旧バージョンの説明書きとファイルを削除VCC_v1.1.1(2026/06/09) 地域による小数点表記の違いに対応。選択と出力に日時を含める変更 ->OutputLogLoaderをv1.1.1に更新
